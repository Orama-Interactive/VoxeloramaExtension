...
func export_obj():
	...
	## Export texture (taken from Variable's Asset Maker)
	if mat.albedo_texture != null:
			var img_texture :Image = mat.albedo_texture.get_data()
			img_texture.flip_y()
			var image_filename: String = path + ".png"
			var _error = img_texture.save_png(image_filename)
			matcont += "map_Kd " + file_name + ".png\n"
